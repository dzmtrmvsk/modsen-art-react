...
## ЛИЧНЫЕ УТОЧНЕНИЯ
1. Так как деплой был произведен на бесплатную платформу Vercel, то вместо кастомного 404 будет отображаться виджет от Vercel. Аналогично с попыткой попасть на страницу отдельной картины через URL - запросится документ с Vercel и будет показана 404 ошибка.
2. Покрытие тестами:
![image](https://github.com/user-attachments/assets/48eff668-e434-474e-b5a9-12c77407ebb0)
